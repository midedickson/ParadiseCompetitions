...
from .views import ProductDetailView, ProductListView, OrderItemDeleteView, OrderDetailView, CountryListView, ShippingAddressCreateView, ShippingAddressDeleteView, ShippingAddressListView, ShippingAddressUpdateView, AddCouponView
