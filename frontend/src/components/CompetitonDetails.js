  ...
  return (
    <>
      <div>
        ...
        {competition && (
          <>
            <img src={competition.prize_to_win.image} alt={"image"} />
            <div>677 left</div>
            ...
            <div>
              First click a letter, then cjoose a number. Repeat this in case
            ...
            <button onClick={() => addTCart(competition.id, ticket)}>
              BookNow
            </button>
          </>
        )}
